...
```bash
bash .cursor/skills/golang-architect/scripts/sqlc-init.sh [project-dir] [db-engine]
```
...
**Examples:**
```bash
bash .cursor/skills/golang-architect/scripts/sqlc-init.sh
bash .cursor/skills/golang-architect/scripts/sqlc-init.sh ./my-project postgresql
```
