...
- [references/entities-and-value-objects.md](references/entities-and-value-objects.md) - Entities, Value Objects, and Factories
- [references/aggregates-and-repositories.md](references/aggregates-and-repositories.md) - Aggregates, Repositories, and Domain Services
- [references/events-and-specifications.md](references/events-and-specifications.md) - Domain Events and Specifications
